...
#   Main unified search()
# -------------------------
def Search(query, client, collection_name, groq_key=None, mode="default", top_k=3):
    """
    ...
    """
    embedding_model = HuggingFaceEmbeddings(model_name="dangvantuan/sentence-camembert-base")
    # -------------------------
...
def GenerationGroq(query, search_results, groq_key, temperature=0.6, max_tokens=2000):
    ...
    svp ne pas ajouter des chose que vous ne savez pas avec certitude.
